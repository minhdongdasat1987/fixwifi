...
def usage():
    return """
pixiefite 0.0.1 (c) 2023 rofl0r, drygdryg modded by vladimir127001
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='pixiefite 0.0.1 (c) 2023 rofl0r, drygdryg modded by vladimir127001',
    ...
    parser.add_argument(
        '--vuln-list',
        type=str,
        default=os.path.dirname(os.path.realpath(__file__)) + '/vulnlist.txt',
